    ...
    function recalculateMap() {
        ...
        for (var i = 0; i < map.length; i++) {
            for (var j = 0; j < map[i].length; j++) {
                ...
                if (map[i_minus][j_minus] == 1)
                    neighborhoodCount++;
                if (map[i][j_minus] == 1)
                    neighborhoodCount++;
                if (map[i_plus][j_minus] == 1)
                    neighborhoodCount++;
                ...
                if (map[i_minus][j_plus] == 1)
                    neighborhoodCount++;
                if (map[i][j_plus] == 1)
                    neighborhoodCount++;
                if (map[i_plus][j_plus] == 1)
                    neighborhoodCount++;

                if (map[i][j] === 0 && neighborhoodCount === 3) {
                    next_map[i][j] = 1;
                }

                if (map[i][j] === 1 && (neighborhoodCount < 2 || neighborhoodCount > 3)) {
                    next_map[i][j] = 0;
                }
            }
        }
